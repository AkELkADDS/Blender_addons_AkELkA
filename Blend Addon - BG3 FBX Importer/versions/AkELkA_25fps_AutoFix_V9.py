...
def rotateObjectEachFrame(obj):
    ...
    # -------------------------------------
    # 2) Clamp frames to integer domain:
    # -------------------------------------
    ...
    # 3) Insert rotation keys only on clean frames
...
class OBJECT_OT_Noira_FBXImporter(Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        for current_file in self.files:
            ...
            # This preserves all rotation/bone corrections but avoids creating keys outside the clamped range.
            for obj in importedObjects:
